...
export const mockChatMessages: ChatMessage[] = [
  {
    id: "1",
    content:
      "Hello! I'm here to help you achieve your goals. How are you feeling about your progress today?",
    sender: "ai",
  ...
  },
  {
    id: "2",
    content:
      "I'm doing well! I completed my reading task but struggled with meditation today.",
    sender: "user",
  ...
  },
  {
    id: "3",
    content:
      "That's great progress on the reading! Don't worry about the meditation - consistency comes with practice. Would you like some tips for making meditation easier?",
    sender: "ai",
