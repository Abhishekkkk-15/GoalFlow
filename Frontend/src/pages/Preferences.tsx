    ...
    return (
      <div className="min-h-screen bg-gray-50 p-4 lg:p-8">
        <div className="max-w-5xl mx-auto">
          <PageHeader title="Preferences" description="Loading preferences..." />
        </div>
      </div>
    );
  }
              ...
              <select
                ...
                onChange={(e) =>
                  setPrefs((prev) => ({
                    ...
                    dashboard: {
                      ...(prev?.dashboard ?? {}),
                      defaultView: e.target.value as "daily" | "weekly" | "monthly",
                    },
                  }))
                }
              ...
              <select
                ...
                onChange={(e) =>
                  setPrefs((prev) => ({
                    ...
                    dashboard: {
                      ...(prev?.dashboard ?? {}),
                      sortBy: e.target.value as "dueDate" | "priority" | "category",
                    },
                  }))
                }
                className="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-900 bg-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                onChange={(e) =>
                  setPrefs((prev) => ({
                    ...
                    analytics: {
                      ...(prev?.analytics ?? {}),
                      preferredChartType:
                        e.target.value as "line" | "bar" | "calendar",
                    },
                  }))
                }
                className="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-900 bg-white"
            ...
            <div className="md:col-span-1">
              ...
              <div className="space-y-2">
                {metricOptions.map((m) => {
                  const checked = normalized.analytics.metricsToShow.includes(m);
                  return (
                    <label
                      key={m}
